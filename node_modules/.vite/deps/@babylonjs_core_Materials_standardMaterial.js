      ...
      const effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-FVDRQUIX.js"), import("./default.fragment-DTR2V7NP.js")]);
          } else {
            await Promise.all([import("./default.vertex-XKMGHC3X.js"), import("./default.fragment-3RBBKBYA.js")]);
          }
