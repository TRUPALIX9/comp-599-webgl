...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-YFCJC2ZC.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      ...
      list.push(Promise.all([import("./@babylonjs_core_Shaders_postprocess__vertex.js")]));
    }
  }
  /**
...
//# sourceMappingURL=chunk-BRQP5ZEP.js.map
